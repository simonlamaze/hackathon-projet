...
import '../css/chessground.base.override.css'
...
//Affiche les variantes dans la zone prévue à cete effet
...
function startReviewMode(couleur) {
  ...
  movable: {
    ...
    // Maintenant en mode révision, on compare ce coup avc le coup du PGN
